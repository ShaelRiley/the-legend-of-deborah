...
for sample=1,16 do
 ...
 for _,spec in ipairs(specs) do
  ...
  assert(not p.developerDenseTesting and p.populationRevision=='b28','not the release plan')
  ...
  assert(snapshot.ready and snapshot.revision=='b28' and snapshot.plannedBodies==bodies)
