...
def main():
    ...
    # Bound generated server source chunks so Lua can load the canonical document;
    # the server compresses and streams these bytes to each reader on demand.
