...
for term in ['The amber Metrocop hears', 'The violet fast zombie remembers', 'The pale-cyan slave Vortigaunt draws', 'The crimson Combine elite marks', 'Outrider', 'Conductor', 'lone bracket glyph', 'linked 64-unit circles', 'TIME OVER','1,800','Black Keycard','Backstab','Quickstep','Rebuff','Stink Bomb','Arcane Surge','DFTs normally mint','Abundance','SECURE THE BAG','Nessa','Beam Sweeper']:
