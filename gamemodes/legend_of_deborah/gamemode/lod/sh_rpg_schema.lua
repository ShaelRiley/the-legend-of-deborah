...
RPG.ArchetypeProgressionTemplates = {
    ...
    interposer = archetypeTemplate(14, 11, 14, 10, 12, 9, 75, 25, 0, 10, 55, 6, false, "interposer"),
    mourner = archetypeTemplate(10, 12, 11, 13, 12, 10, 40, 60, 0, 8, 50, 5, false, "mourner"),
    censor = archetypeTemplate(11, 12, 12, 13, 12, 10, 50, 50, 0, 8, 50, 5, false, "censor"),
    surveyor = archetypeTemplate(9, 11, 11, 15, 14, 10, 0, 0, 100, 8, 55, 5, true, "surveyor"),
    relay = archetypeTemplate(11, 13, 11, 13, 12, 10, 35, 65, 0, 8, 50, 5, false, "relay"),
    lacemaker = archetypeTemplate(12, 12, 12, 11, 12, 10, 60, 40, 0, 8, 50, 5, false, "lacemaker"),
    halter = archetypeTemplate(12, 11, 12, 12, 12, 9, 65, 35, 0, 8, 50, 5, false, "halter"),
    pacer = archetypeTemplate(10, 15, 10, 12, 12, 9, 35, 65, 0, 8, 50, 5, false, "pacer"),
