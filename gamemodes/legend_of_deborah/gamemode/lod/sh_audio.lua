...
local names={'hit_confirm','spatial_awareness','loot_spawn','loot_pickup','confirm','deny','dialogue','gift',
    ...
    'portal_depart','portal_arrive','cast','summon_attack','boss_arrive','item_discard','heal','status_reckless','status_clumsy','status_shattered','status_confused','summon_arrive','summon_depart','enemy_defeated','boss_taunt','cloud_step'}
