...
E.StatusPresentation={
 immolated={label='IMMOLATED',key='Immolated',color={255,95,35},sound='legend_of_deborah/feedback/status_immolated.wav'},
 poisoned={label='POISONED',key='Poisoned',color={90,205,75},sound='legend_of_deborah/feedback/status_poisoned.wav'},
 bleeding={label='BLEEDING',key='Bleeding',color={200,40,55},sound='physics/flesh/flesh_impact_bullet1.wav'},
 clumsy={label='CLUMSY',key='Clumsy',color={225,165,75},sound='legend_of_deborah/feedback/status_clumsy.wav'},
 muted={label='MUTED',key='Muted',color={200,190,225},sound='legend_of_deborah/feedback/status_muted.wav'},
 held={label='HELD',key='Held',color={90,200,255},sound='legend_of_deborah/feedback/status_held.wav'},
 reckless={label='RECKLESS',key='Reckless',color={245,120,150},sound='legend_of_deborah/feedback/status_reckless.wav'},
 arcane_shattered={label='SHIELD SHATTERED',key='ArcaneShattered',color={175,90,245},sound='legend_of_deborah/feedback/status_shattered.wav'},
 intimidated={label='INTIMIDATED',key='Intimidated',color={230,205,60},sound='legend_of_deborah/feedback/status_intimidated.wav'},
 morale_flee={label='FLEEING',key='MoraleFlee',color={230,205,60},sound='legend_of_deborah/feedback/status_confused.wav'}
}
