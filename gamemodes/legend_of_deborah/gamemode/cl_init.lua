...
include("lod/cl_entry_safety.lua")
...
include("lod/cl_container_branding.lua")
include("lod/cl_crate_preview.lua")
...
include("lod/cl_feedback_language.lua")
...
include("lod/cl_monster_identity.lua")
include("lod/cl_magic.lua")
include("lod/cl_wizard_fx.lua")
include("lod/cl_spellbook.lua")
include("lod/cl_equipment.lua")
include("lod/cl_summon_card.lua")
include("lod/cl_equipment_moves.lua")
include("lod/cl_equipment_thunder.lua")
include("lod/cl_equipment_icons.lua")
include("lod/cl_weapon_appearance.lua")
include("lod/cl_weapon_segments.lua")
include("lod/cl_equipment_inventory.lua")
include("lod/cl_magic_spectacle.lua")
include("lod/cl_magic_form_fx.lua")
include("lod/cl_wall_preview.lua")
include("lod/cl_pushback_fx.lua")
include("lod/cl_character_portrait.lua")
include("lod/cl_character_sheet.lua")
include("lod/cl_status_portrait.lua")
include("lod/cl_haste.lua")
include("lod/cl_soldier_queue_ui.lua")
include("lod/sh_heroes_of_legend.lua")
include("lod/cl_heroes_of_legend.lua")
