...
include("lod/sh_travel_items.lua")
...
if SERVER then
    ...
    include("lod/sv_rpg_gate_e_rate_of_fire.lua")
    include("lod/sv_rpg_gate_e_rate_of_fire_runtime.lua")
    ...
    include("lod/sv_rpg_gate_e_magic_recovery.lua")
    include("lod/sv_rpg_gate_e_pusher.lua")
    include("lod/sv_rpg_gate_e_crowbar.lua")
    ...
    include("lod/sv_rpg_gate_e_burst_size.lua")
