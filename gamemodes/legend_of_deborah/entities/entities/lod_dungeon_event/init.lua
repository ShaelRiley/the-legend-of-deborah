...
function ENT:Use(ply)
    ...
    if not ok and IsValid(ply) and ply:IsPlayer() and CurTime()>=(self.LODNextNotice or 0) then
        ...
        ply:ChatPrint((archetype=='bribe_blockade' and 'BRIBE BLOCKADE — ' or archetype=='warp_hole' and 'WARP HOLE — ' or vending and 'DEBBIE VENDING — ' or archetype=='treasure_chest' and 'TREASURE CHEST — ' or chest and 'LOCKED CHEST — ' or 'DEBBIE SLOTS — ')..message)
    end
end
