...
function ENT:Initialize()
    ...
    if form == "watermelon" then LOD.MagicForms:InitWatermelon(self) end
...
function ENT:Think()
    ...
    if self.LODFormId=="watermelon" then return LOD.MagicForms:StepWatermelon(self,dt,traceFilter(self)) end
    steer(self, dt)
