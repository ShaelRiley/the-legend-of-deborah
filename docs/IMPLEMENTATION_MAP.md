...
- Shotgun: shared damage `1d6!`, floor 3, natural **6 only** recursively explodes; 8 guaranteed pellets plus a separate exploding `1d6!` additional-pellet roll; one aggregate resolution per target, **4× ordinary hit stun**, **168-unit nominal push**, and a 36-pellet hard safety cap. The exploding pellet die averages 4.2 extra pellets, producing an uncapped 12.2-pellet shell average and approximately 9.76 expected full-connect base damage before later modifiers.
