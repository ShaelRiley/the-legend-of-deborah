...
| Pushback body-ghost trail / wall-crush particles + slam cue | `cl_pushback_fx.lua`; distance-scaled 16–24 cached-model silhouettes span the resolved path with bounded lifetime/distance culling; inherited by Shotgun, Force Shout, and future shared push sources |
