...
Runtime identity: `stability-20260915-05`. Live GDD navigation: 00 → 01 → 03 and 06;
...
- Shotgun hits were inferred from `EntityTakeDamage`, after Source may combine
  ...
  the shell. Split targets receive their actual pellet counts.
...
Baseline: 95 suites passed. Stabilization checkpoint: **98 suites pass**, including
...
The wiring audit resolves 463 literal include/distribution paths and checks
...
`build=stability-20260915-05`, `missing=none`, and zero new Lua errors.
...
with the existing TIME OVER testkit and confirm reset releases UI/models.
