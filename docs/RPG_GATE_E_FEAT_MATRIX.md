...
- **Docs-only:** 21 feats (28%)
- **In-progress:** 0 feats (0%)
- **Implemented in code:** 54 feats (71%)
- **Gameplay coverage:** ~71%

## Implementation evidence

The active modular runtime under `gamemodes/legend_of_deborah/gamemode/lod/` now includes Gate E Batch 1 feat identity/computation, Batch 2 class-combat hooks, Batch 3 hit-stun, Batch 4 movement, Batch 5 reload-speed, Batch 6 rate-of-fire, Batch 7 burst-size, Batch 8 regeneration, Batch 9 breadcrumb, Batch 10 ammo generation, Batch 11 Greater Regeneration, Batch 12 Synergistic reloading/slow/accuracy effects, Batch 13 damage-reduction armor scaling, and Batch 14 accepted Crowbar-family composition, plus the pre-existing Phase C class/ammo systems. Gate E Batch 15 Blast-Proof is accepted after runtime validator/testkit evidence confirmed central incoming explosion-continuation suppression, mid-chain preservation, ownership/scope guards, cooldown behavior, and automatic 2.0-second recharge. Static status below reflects actual runtime wiring, not GDD-only documentation.
...
| Blast-Proof | CON 15 | Implemented | Gate E Batch 15 accepted central incoming exploding-damage continuation suppression with mid-chain preservation, ownership/scope guards, explicit `BLAST-PROOF` logging, and per-defender 2.0-second recharge |
