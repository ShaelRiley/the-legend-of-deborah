...
| `DEX_RATE_OF_FIRE_1`<br>Hair Trigger | DEX / Fire cadence | Catalog/ownership only | Definition/ownership present; gameplay bridge still pending. |
| `DEX_RATE_OF_FIRE_2`<br>Rapid Fire | DEX / Fire cadence | Not yet catalogued | Not yet catalogued/bridged; exact live-GDD definition remains authoritative. |
| `DEX_RATE_OF_FIRE_3`<br>Lead Storm | DEX / Fire cadence | Not yet catalogued | Not yet catalogued/bridged; exact live-GDD definition remains authoritative. |
